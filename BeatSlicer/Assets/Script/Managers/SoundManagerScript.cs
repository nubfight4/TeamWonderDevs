...
public enum AudioClipID
{
    ...
    SFX_BULLET_REFLECT_WALL = 106,
    SFX_CHARGE_READY = 107,

    SFX_BOSS_APPEARING = 200,

    SFX_BULLET_BOMBING_RUN_DROPPING = 300,
    SFX_BULLET_BOMBING_RUN_TOUCHDOWN = 301,

    BGM_ULTIMATE_ATTACK = 9000,
